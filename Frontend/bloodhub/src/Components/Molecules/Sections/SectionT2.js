...
export default function SectionT2({sectionHead,sectionDesc,sectionImgSrc,varColor,className,style}) {
    const sectionStyle = {
        backgroundColor: `var(${varColor})`,
        ...style
    };
  return (
    <section className={`sectionPadding pt-5 pb-4 ${className}`} style={sectionStyle} >
